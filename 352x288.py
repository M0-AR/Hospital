...
def main(VIDEO_NAME, detection_statistics):
    ...
    SAVE_PATH = 'F:/Mohamad_Temp/352x288_annotation/'
    ...
    # Note: In this example, we assume every video processes successfully.
    # You might want to add error-handling to detect corrupted or unsupported files.

if __name__ == "__main__":
    DIRECTORY_PATH = 'C:/Users/UKF/Desktop/new_110_videos__'
    ...
    # Save results to CSV
    with open('352x288_auto_annotation.csv', 'w', newline='') as csvfile:
